...
//Creating Guest list 
let Guest_List:string[]=["Ali", "Noor", "Sidra", "Hania",];
//Creating a veriable for the guest who is not comming to dinner
let Not_comming=Guest_List[3];
//Printing the name of guest who is unable to com
console.log(`hello! friends, it is to inform you that "${Not_comming}" is not comming to dinner.`);
...
Guest_List.forEach(to_eachguest => console.log(`Hi ${to_eachguest}, You are invited to dinner.`));
