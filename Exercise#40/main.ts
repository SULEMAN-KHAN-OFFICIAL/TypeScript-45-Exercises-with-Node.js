...
// Calling 3 functions by creating 3 veriable with different values
let album1= make_album("Salman","Album title 1");
let album2= make_album("Aamir","Album title 2");
let album3= make_album("Shahid","Album title 3",7);
